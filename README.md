...
⬤ [rasta](https://github.com/tstih/rasta) · Lightweight SDL2-based framebuffer and input emulator for Linux.   
⬤ [more](https://github.com/tstih/more) · Collection of MIT-licensed WinForms controls for .NET Core.  
⬤ [mms](https://github.com/tstih/mms) · Modern C++ memory‑mapped reader library for compilers assemblers, and linkers.   
...
⬤ [squid-server](https://github.com/retro-plastics/squid-server) · A lightweight, plugin-based Linux server that hosts the libsquid protocol engine and dispatches squid packets to dynamically loaded plugins.  
...
⬤ [cpm3-app](https://github.com/retro-vault/cpm3-app) · a minimal SDCC-based CP/M application using docker and libcpm3-z80.  
